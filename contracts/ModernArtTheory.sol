...
contract ModernArtTheory is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
  ...
  address[] private _team = [
    0x85a5D9347fF88D03FFcD01aD9393Cf7d42acfA92, // Admin Account gets 25% of the total revenue
    0xbDF686f422215CfD1071227E07392f1Ee00cbAd3 // Test Account gets 35% of the total revenue
  ];
  ...
  function presaleMint(
    ...
    require(msg.sender == account, 'Modern Art Theory: Not allowed');
    require(presaleM, 'Modern Art Theory: Presale is OFF');
    require(!paused, 'Modern Art Theory: Contract is paused');
    require(
      _amount <= presaleAmountLimit,
      "Modern Art Theory: You can't mint so much tokens"
    );
    require(
